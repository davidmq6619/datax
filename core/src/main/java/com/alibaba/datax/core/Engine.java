...
public class Engine {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
        /*    //设置运行的datax的家目录
            System.setProperty("datax.home", "F:\\mq\\work\\workspace\\DataX\\core\\target\\datax");
            //设置datax的运行脚本信息
            args = new String[]{"-mode", "standalone", "-jobid", "-1", "-job", "F:\\mq\\work\\workspace\\DataX\\core\\src\\main\\job\\local\\mysql.json"};
*/
            Engine.entry(args);
        } catch (Throwable e) {
            exitCode = 1;
