...
public class PostgresqlReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        private SinohealthRdbmsReader.Job commonRdbmsReaderMaster;
        ...
        public void init() {
            ...
            this.commonRdbmsReaderMaster = new SinohealthRdbmsReader.Job(DATABASE_TYPE);
    ...
    public static class Task extends Reader.Task {
        ...
        private SinohealthRdbmsReader.Task commonRdbmsReaderSlave;

        @Override
        public void init() {
            this.readerSliceConfig = super.getPluginJobConf();
            this.commonRdbmsReaderSlave = new SinohealthRdbmsReader.Task(DATABASE_TYPE,super.getTaskGroupId(), super.getTaskId());
