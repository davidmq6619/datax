package com.sinohealth.datax.plugin.reader.sqlserverreader;
...
public class SinohealthSqlServerReader extends Reader {
	...
	public static class Job extends Reader.Job {
		...
		public void init() {
			...
			int fetchSize = this.originalConfig.getInt(
					com.alibaba.datax.plugin.rdbms.reader.Constant.FETCH_SIZE, 1024);
			if (fetchSize < 1) {
